...
impl SourceFile {
    ...
    pub fn parse(&self) -> Vec<crate::core::Spanned<crate::core::Node>> {
        let s = crate::parse::ParserSpan::new(&self.src);
        let (_s, v) = crate::parse::parse_gwii(s).unwrap_or((s, Vec::new()));
